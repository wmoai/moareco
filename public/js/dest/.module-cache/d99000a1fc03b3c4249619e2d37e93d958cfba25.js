var Program = React.createClass({displayName: "Program",
  ...
  render: function() {
    ...
    return (
      React.createElement("a", {href: "/program/"+this.props.program._id, className: classString, style: this.props.style, onMouseEnter: this.forcus, onMouseLeave: this.removeForcus}, 
...
var TimeBar = React.createClass({displayName: "TimeBar",
  ...
  test: function(e) {
    // console.log(this.getDOMNode().offsetTop);

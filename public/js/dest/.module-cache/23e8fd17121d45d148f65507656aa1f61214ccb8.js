var Program = React.createClass({displayName: "Program",
  ...
  render: function() {
    return (
      React.createElement("a", {href: "/program/"+this.props.program._id, className: "program", style: this.props.style}, 
    ...
    return (
      React.createElement("div", {id: "hour"}, 
        this.state.hours.map(function(hour) {
          return (
            React.createElement("div", {style: {height: this.props.pxpm * 60}}, 
              hour
            )
          )
        })
  ...
  render: function() {
    return (
      React.createElement("div", {id: "programs"}, 
        React.createElement(TimeBar, {startTime: this.state.startTime, interval: 12}), 

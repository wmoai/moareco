...
var Channel = React.createClass({displayName: "Channel",
  ...
  _listen: function(e) {
    // if (window.scrollY + window.innerHeight
      // >= this.getDOMNode().clientHeight + this.getDOMNode().offsetTop - 50) {
      // this._update();
    // }
  },
  _update: function() {
...
var TimeBar = React.createClass({displayName: "TimeBar",
  ...
  _listen: function(e) {
    ...
    var bounds = lastChild.getBoundingClientRect();
    console.log(lastChild.offsetTop + this.getDOMNode().offsetTop);
    console.log(window.scrollY + window.innerHeight);
    // var endDom = React.findDOMNode(this.refs.end);
    // if (window.scrollY + window.innerHeight
      // >= endDom.offsetTop + endDom.clientHeight - 40) {
      // this._update();
    // }
  },
  _update: function() {

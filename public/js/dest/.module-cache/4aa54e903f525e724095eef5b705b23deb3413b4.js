...
var TimeBar = React.createClass({displayName: "TimeBar",
  ...
  _listen: function(e) {
    var hourElem = document.elementFromPoint(10,82);
    ...
    return (
      React.createElement("div", {id: "programs"}, 
        ...
        this.props.sids.map(function(sid) {
          return (
            React.createElement(Channel, {sid: sid, startTime: this.state.startTime, pxpm: this.props.pxpm, interval: this.props.interval})
          );
        })
      )
    );
...
window.onload = function() {
  var now = new Date().getTime();
  React.render(
    React.createElement(Programs, {startTime: now, interval: 12, pxpm: 4, sids: [1024,23608]}),

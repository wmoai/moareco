var Program = React.createClass({displayName: "Program",
  ...
  render: function() {
    return (
      React.createElement("a", {href: "/program/"+this.props.program._id, className: "program"}, 
    ...
    return (
      React.createElement("div", {className: "channel", style: {height:'1000px'}}, 
        this.state.programs.map(function(program) {
          ...
          return (
            React.createElement(Program, {pid: program._id, title: program.title, style: style}, 
              program.detail
            )
          )
        })
